...
# Export data
# ggsave(g, filename=file.path(plotdir, "Fig6_rec_impacts_long.pdf"),
...
# Export
ggsave(g, filename=file.path(plotdir, "FigS2_rec_impacts_wide.png"),
       width=8, height=8, units="in", dpi=600)
ggsave(g, filename=file.path(plotdir, "FigS2_rec_impacts_wide.pdf"),
       width=8, height=8, units="in", dpi=600)
